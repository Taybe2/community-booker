...
from community_centre.models import CommunityCentre  # Import CommunityCentre model
...
class TimeSlotViewTests(TestCase):
    ...
    def test_unauthorized_edit_booking(self):
        ...
        self.assertEqual(str(messages[0]), "You are not authorized to edit this booking.")
    ...
    def test_slots_displayed_correctly(self):
        ...
        for day, slots in slots_by_day.items():
            self.assertTrue(all(isinstance(slot['slot'], TimeSlot) for slot in slots))
